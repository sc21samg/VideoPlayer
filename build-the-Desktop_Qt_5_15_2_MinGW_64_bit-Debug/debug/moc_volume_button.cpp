/****************************************************************************
** Meta object code from reading C++ file 'volume_button.h'
**
...
#include <memory>
#include "../../2811_cw2-master-release/volume_button.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'volume_button.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 13, 19), // "pressedThisLocation"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 13) // "emmitLocation"

    },
    "VolumeButton\0pressedThisLocation\0\0"
    "emmitLocation"
};
...
void VolumeButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pressedThisLocation((*reinterpret_cast< QRect(*)>(_a[1]))); break;
        case 1: _t->emmitLocation(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (VolumeButton::*)(QRect );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VolumeButton::pressedThisLocation)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VolumeButton::pressedThisLocation(QRect _t1)
{
